...
public class Clock {
    ...
    */
    ...
    public static double timeSlice = 0.0;
    ...
    //will need to keep track of number of seconds.
    ...
    */
    public double tick() {
        //what am i doing? adding another tick to the value.
        //how do i do it? change the double by what?
        //what is a second(time) in code?
        //what is the value that i want to change with every tick?
        seconds += timeSlice;


        //how do?
        //for every tick(second), increase HOUR_HAND_DEGREES_PER_SECOND
        //and increase MINUTE_HAND_DEGREES_PER_SECOND
        return seconds;
    }
    ...
    */
    public double validateAngleArg( String argValue ) throws NumberFormatException {
        ...
        try {
            Double argumentValue = Double.valueOf(argValue);
            if ((argumentValue < 0.0) || (argumentValue > 360.0)) {
                return(INVALID_ARGUMENT_VALUE);
            }
            angle = argumentValue;
        }catch (Exception e) {
            throw new IllegalArgumentException ("Enter an angle in double format.");
        }
        return angle;
    }
    ...
    */
    public String toString() {
        ...
        System.out.println("secondsString = " + secondsString);
    ...
    */
    public static void main( String args[] ) {
        ...
        try {
            ...
            System.out.println( (135.0001 == clock.validateAngleArg( "135.0001" )) ? " - Correct: 135.001" : angle );
            ...
            System.out.println("timeSlice tests");
            System.out.println( (60.0 == clock.validateTimeSliceArg( "0")) ? " - Correct: 60.0" : timeSlice);
            ...
            if (clock.handAngle == clock.angle) {
                System.out.println("wooooooo" + clock.toString());
            }
            ...
            System.out.println(clock.getHandAngle());
            if (clock.handAngle == clock.angle) {
                System.out.println("woooow" + clock.toString());
            }
            System.out.println(clock.tick());
            System.out.println(clock.getHourHandAngle());
            System.out.println(clock.getMinuteHandAngle());
