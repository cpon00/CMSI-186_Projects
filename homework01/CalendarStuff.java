...
public class CalendarStuff {
  ...
  /**
   *I want to count the number of days until the first date in the year, then subtract
   *the number of days from the second. To do this, I need to count how many days are before
   *the date.
   */


  /**
   *This section will determine the difference between years of the two dates and change
   *the day count accordingly. If one of the years is a leap year, there are two separate
   *statements that account for that. if no years are leap years,
   */
       ...
       if (year1 != year2) {
          //IF YEAR 1 != year2
           if (year1 > year2) {
               ...
               for (int yearDiff = (int)year2; yearDiff < (int)year1 - 1; yearDiff++) {
           ...
           //this function will run until monthDiff, equal to month2, reaches the first month.
               daysDiff4 += days[monthDiff];
           }
           daysDiff4 += (int)day2;
           if (daysDiff4>daysDiff3) {
               dayCount += (daysDiff4 - daysDiff3);
           }else{
               dayCount += (daysDiff3 - daysDiff4);
           }


           daysTotalDiff2 = Math.abs(daysDiff3-daysDiff4);
           dayCount = daysTotalDiff2;
